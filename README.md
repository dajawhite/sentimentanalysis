...
1. How do you classify a new tweet? Give a short description of the main steps.
    ...
    > (a)Tokenize the tweet
      (b)If a word appears in the positive word vector increment positive count. (vice versa for negative words)
      (c)If the tweet had more positive than negative words, it is positive, and vice versa.

2. What is the time complexity of your training implementation (Big-Oh notation)? Explain why.

   > O(N)
   - I have a sequence of for loops, but they are not nested.

3. What is the time complexity of your classification implementation (Big-Oh notation)? Explain why.

   > O(N^2) 
   - I have a nested for loop included in this implementation

4. How do you know that you use proper memory management? That is that you do not have
   a memory leak?

   > I'm not 100% confident there are no memory leaks. However, I think I used dynamic memory allocation properly (for every new, there's a delete);

5. What was the most challenging part of the assignment?

   > Definitely time management and memory management.
